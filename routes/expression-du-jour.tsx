  ...
  head: () => ({
    meta: [
      { title: "Expression du jour — Day 1 « What's Up? » | HiTako Academy" },
      {
        name: "description",
        content:
          "Hianatra ny fomba fiteny « What's up? » sy ny famaliana azy — fiteny anglisy fahita isan'andro, hazavaina amin'ny teny malagasy.",
      },
    ...
    <div className="animate-fade-up text-center">
      ...
      <div className="mx-auto mt-8 max-w-md rounded-2xl bg-gradient-brand p-5 text-left text-primary-foreground shadow-elegant">
        ...
        <div className="mt-1 text-sm text-white/85">
          🇲🇬 Fiarahabana tsotra — fomba fiarahabana ny namanao amin'ny teny Anglisy
        </div>
      </div>
  ...
  return (
    <div className="animate-fade-up">
      <StepHeader
        ...
        subtitle="Ny fiarahabana tsotra dia matetika fohezina rehefa miteny haingana ny Amerikana."
      />
  ...
  return (
    <div className="animate-fade-up">
      <StepHeader
        emoji="🗣️"
        title="Fanononana"
        subtitle="Henoy tsara ny fanononana, avereno moramora aloha, ary ampiakaro tsikelikely ny hafainganam-pitenenanao."
      />
      ...
      <div className="mt-4 space-y-2.5">
        {PRONUNCIATION.reps
          .filter((rep, index, self) => self.indexOf(rep) === index)
          .map((rep, i) => (
            <div
              key={`${rep}-${i}`}
  ...
  return (
    <div className="animate-fade-up">
      <StepHeader
        ...
        subtitle="Ahoana no famaliana — 7 fomba famaliana fahita indrindra."
      />
  ...
  return (
    <div className="animate-fade-up">
      <StepHeader
        ...
        subtitle="Rahoviana no tsy tokony hampiasaina — ny « What's up? » dia teny tsotra (casual), ka aza ampiasaina amin'ny toe-javatra ofisialy."
      />
...
function ReviewStep({ onNext, onBack }: { onNext: () => void; onBack: () => void }) {
  return (
    <div className="animate-fade-up">
      ...
      <StepNav onBack={onBack} onNext={onNext} nextLabel="Hamaranana ny lesona" />
    </div>
  );
}
  ...
  return (
    <div className="animate-pop-in text-center">
      ...
      <p className="mx-auto mt-3 max-w-md text-ink-soft">
        ...
        » amin'ny teny Anglisy ianao — anisan'ny fiteny fahita isan'andro any Amerika.
      </p>
      ...
      <div className="mx-auto mt-8 max-w-md rounded-2xl border border-primary/20 bg-primary/5 p-5 text-sm text-foreground">
        Mianara 10–15 minitra isan'andro ato amin'ny <strong>HiTako Academy</strong> — lesona
        mifanaraka aminao, na kilasy mivantana miaraka amin’ny coach.
      </div>
